...
describe("capstone-escrow - devnet", function () {
  this.timeout(60000);
  ...
  before(async () => {
    ...
    // user account should already be funded for ease
    // maker | wL1 | notWL
  ...
  it("Should successfully claim tokens with whitelisted address", async () => {
